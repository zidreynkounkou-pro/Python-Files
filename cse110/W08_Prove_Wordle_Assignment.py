user_name = input("Enter your full name here please: ").capitalize()
print()
print("Welcome to the word guessing game dear",user_name + "!")
print()

import random
book = ["mosiah","moroni","2nephi","ether","3nephi","helaman","1nephi","jacob","mormon","4nephi","alma","enos","jarom","words of mormom"]
...
# Checking the guess in the secret word, then providing a hint
    ...
    print("Your hint is: ","  ".join(hint_s))
